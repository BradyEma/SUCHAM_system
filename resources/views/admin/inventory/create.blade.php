...
<body class="bg-gray-50 font-sans">
        ...
        <main class="flex-1 py-8">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white shadow-lg rounded-xl overflow-hidden">
                    ...
                    <!-- Form Content -->
                    <form action="{{ route('admin.inventory.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                        @csrf
    ...
    <option disabled selected>Select Supplier Email</option>
    @foreach ($suppliers as $supplier)
        @if ($supplier->user)
            <option value="{{ $supplier->user->email }}">{{ $supplier->user->email }}</option>
        @endif
    @endforeach
</select>
</div>
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="mt-1">
                                    <textarea id="description" name="product_description" rows="3"
                                        class="block w-full p-3 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500"
                                        placeholder="Enter product details, features, etc."></textarea>
                                </div>
                            </div>
                        </div>

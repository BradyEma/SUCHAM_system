...
<body class="bg-gray-50 font-sans">
    <div class="flex min-h-screen">
        <!-- Sidebar would be included here in a full application -->
            ...
            <header class="bg-white border-b border-gray-200">
                <div class="flex items-center justify-between px-6 py-4">
                    <div class="flex items-center">
                        <h1 class="ml-4 text-xl font-semibold text-gray-800">Inventory Management</h1>
                    </div>
            ...
            <main class="flex-1 overflow-y-auto p-6">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                    ...
                    <div class="mt-4 md:mt-0 flex space-x-3">
                        <a href="{{ route('admin.inventory.create') }}" class="flex items-center bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-lg shadow">
                            <i class="fas fa-plus mr-2"></i> Add New Item
                        </a>
                        <button class="flex items-center bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 px-4 py-2 rounded-lg shadow">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div class="flex-1">
                            <div class="relative">
                                ...
                                <input type="text" id="search" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500" placeholder="Search products...">
                            </div>
                        </div>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="mt-1 w-full bg-gray-200 rounded-full h-2">
                                            @php
    $reorderLevel = $item->reorder_level ?: 1; // fallback to 1 if null or zero
...
<div class="bg-primary-600 h-2 rounded-full" style="width: {{ $percentage }}%"></div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-3">
                                            <a href="{{ route('admin.inventory.edit', $item->id) }}" class="text-primary-600 hover:text-primary-900">
                                            ...
                                            <a href="{{ route('admin.inventory.show', $item->id) }}" class="text-gray-600 hover:text-gray-900" title="View Details">
                    ...
                    <div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            ...
                            <div class="flex space-x-2">
                                ...
                                @else
                                <a href="{{ $items->previousPageUrl() }}" class="relative inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-md">
                                    Previous
                                </a>
                                @endif
                                ...
                                @foreach ($items->getUrlRange(1, $items->lastPage()) as $page => $url)
                                    ...
                                    @else
                                    <a href="{{ $url }}" class="relative inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-md">
                                        {{ $page }}
                                    </a>
                                    @endif
                                @endforeach
                                ...
                                <a href="{{ $items->nextPageUrl() }}" class="relative inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-md">
                                    Next
                                </a>
                                @else
                                <span class="relative inline-flex items-center px-4 py-2 border border-gray-300 bg-gray-100 text-sm font-medium text-gray-400 rounded-md cursor-not-allowed">

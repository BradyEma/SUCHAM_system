...
<body class="bg-gray-50 font-sans">
    ...
    <span>Messages</span>
                        ...
                        <!-- Support -->
                        <a href="{{ route('admin.customer.segments') }}" class="text-primary-200 hover:bg-primary-700 hover:text-white group flex items-center px-4 py-3 text-sm font-medium rounded-md">

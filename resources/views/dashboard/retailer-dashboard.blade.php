    ...
    <div>
        ...
        <div class="flex-1 overflow-y-auto py-4">
                    <nav class="px-2 space-y-1">
                        ...
                        <!-- Orders -->
                        <a href="{{ route('retailer_wholesaler_orders.index') }}" class="text-primary-200 hover:bg-primary-700 hover:text-white group flex items-center px-4 py-3 text-sm font-medium rounded-md">
